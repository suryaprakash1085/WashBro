    ...
    <section className="bg-slate-50/50 py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 lg:px-8" ref={ref}>
        ...
        <div className="relative grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {steps.map((step, i) => (
            <div key={i} data-reveal className={`stagger-${i + 1} relative text-center`}>
              <div className="relative mx-auto mb-5 flex size-24 items-center justify-center rounded-full bg-white shadow-lg shadow-primary/5">
